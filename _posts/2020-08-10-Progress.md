...
So I have added a new animated intro for the title screen, complete with new effects, and an animated 'flaming' logo, similar to Ultima V. It is pretty sweet, and took a good amount of effort. My first animation, but I think it turned out good (went through 3 iterations). Also added a whole series of screens to the 'view' which tell a story akin to the adventures the player might have in Trinity. All done, done diddly done.

<figure>
	<img class="ScrollRev" data-tilt src="{{ site.url }}/images/title_preview.png" />
	<figcaption>This is a teaser only!</figcaption>
</figure>
...
The tweak I have made was to first restore taverns to Apple II style. The Dos version had many of the taverns giving answers to the six possible queries, whereas the Apple II original has specific taverns only giving one possible response to one of the queries. So 1 query/reponse per tavern.

<figure>
	<img class="ScrollRev" data-tilt src="{{ site.url }}/images/sextant.png" />
	<figcaption>Dos Taverns</figcaption>
</figure>
...
<figure>
	<img class="ScrollRev" data-tilt src="{{ site.url }}/images/sextant.tiff" />
	<figcaption>Apple Original Taverns</figcaption>
</figure>

<figure>
	<img class="ScrollRev" data-tilt src="{{ site.url }}/images/white_stone.tiff" />
	<figcaption>Apple Original Taverns</figcaption>
</figure>

<figure>
	<img class="ScrollRev" data-tilt src="{{ site.url }}/images/nightshade.tiff" />
	<figcaption>Apple Original Taverns</figcaption>
</figure>

I then augmented this by adding 5 more new unique query/response pairs, and a new tavern, for a whole bundle of new tavern rumours.

I had a mind to change the whole systme, and instead of specific queries, only allow the player to ask about rumours. Or to add asking for rumours as an additonal option to specific queries. But ran out of code space. That's okay. Just get it done.
...
I already built the graphics for a 16 by 16 version of Apple II graphics for another, defunct project. So I can now use them here...if I want! Boohoohahahhah!
